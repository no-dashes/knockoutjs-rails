  ...
  (function(undefined) {
    ...
    (function(factory) {
      ...
      (function() {
        ...
        var contextSubscribable = ko.utils.createSymbolOrString(
          "_subscribable"
        );
        var contextAncestorBindingInfo = ko.utils.createSymbolOrString(
          "_ancestorBindingInfo"
        );
        var contextDataDependency = ko.utils.createSymbolOrString(
          "_dataDependency"
        );
        ...
        function applyBindingsToNodeInternal(
          ...
          if (bindings) {
            ...
            if (ko.bindingEvent.descendantsComplete in bindings) {
              contextToExtend = ko.bindingEvent.startPossiblyAsyncContentBinding(
                node,
                bindingContext
              );
              ko.bindingEvent.subscribe(
          ...
          init: function(
            ...
            ko.computed(
              function() {
                ...
                var asyncContext = ko.bindingEvent.startPossiblyAsyncContentBinding(
                  element,
                  bindingContext
                );
            ...
            init: function(
              ...
              ko.computed(
                function() {
                  ...
                  if (needAsyncContext) {
                    bindingContext = ko.bindingEvent.startPossiblyAsyncContentBinding(
                      element,
                      bindingContext
                    );
                  }
      ...
      (function() {
        ...
        ko.utils.setDomNodeChildrenFromArrayMapping = function(
          ...
          for (
            i = 0, nextNodeInDom = ko.virtualElements.firstChild(domNode);
            (mapData = newMappingResult[i]);
            i++
          ) {
            ...
            for (
              j = 0;
              (nodeToInsert = mapData.mappedNodes[j]);
              nextNodeInDom = nodeToInsert.nextSibling,
